use interface::redemption::{ExecuteMsg, OwnerProposal, QueryMsg};
use neutron_test_tube::{Account, Module, RunnerError, Wasm};
...
fn test_update_owner() {
    ...
    let owner: String = wasm.query(&strategy_addr, &QueryMsg::Owner {}).unwrap();
    ...
    // query ownership proposal
    {
        ...
        assert_eq!(proposal.owner.to_string(), env.traders[0].address());
